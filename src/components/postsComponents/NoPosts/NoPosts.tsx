...
export default function NoPosts() {
  ...
  return (
    <div
      className="flex flex-col items-center col-span-3 text-center py-12 max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden md:max-w-2xl p-8 border border-gray-200 dark:border-gray-700"
      role="region"
    >
      <div
